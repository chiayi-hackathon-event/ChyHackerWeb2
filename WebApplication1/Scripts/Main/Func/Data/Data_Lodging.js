define(function () {
    ...
    var _GetSupplyDemand = function (_town_id, _implementtype) {
        var dtd = $.Deferred();
        var _url = window.location.origin + '/ChyHackerAPI/api/CounTownCode';
        var _data = {
            type: 'townsupplydemand',
            town_id: _town_id,
    ...
    var module = {
        ...
        GetSupplyDemand: function (town_id, _implementtype) {
            var dtd = $.Deferred();
            $.when(_GetSupplyDemand(town_id, _implementtype)).then(function (data) { return dtd.resolve(data); })
            return dtd.promise();
        }
